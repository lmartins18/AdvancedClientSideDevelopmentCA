    ...
    return (
      <div className="flex justify-center p-6">
        <div className="mt-16 w-full lg:w-1/3">
          <h2 className="text-3xl font-bold font-uncial text-emerald-700">
            Contact our team
          </h2>
          <div className="mt-6 mb-12">
            <p>
              Welcome to our website! We're thrilled to have you here. Whether
              you're looking to get in touch with our friendly team, explore our
              services, or simply learn more about what we offer, you've come to
              the right place.
            </p>
            <br></br>
            <p>
              At "Le Gros Chef", we're dedicated to providing top-notch services
              tailored to meet your needs. Our team of experts is committed to
          ...
          <form onSubmit={handleSubmit} className="max-w-md">
            ...
            <div className="mb-4">
              ...
              <input
                ...
                title="please use a common email address i.e gmail.com"
                required
                className={`w-full p-2 border ${
            ...
            <button
              ...
              type="submit"
              className="bg-emerald-500 text-white py-2 px-4 rounded-md flex items-center"
            >
    ...
    <div className="flex justify-center p-6">
      <div className="mt-16 w-full lg:w-1/3">
        {state.result.kind === "success" ? (
          ...
          // Error message
          <>
            <h2 className="text-3xl font-bold font-uncial text-red-500">
              Oops!
            </h2>
            <p>
